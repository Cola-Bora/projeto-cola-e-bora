...
export class ongUpdate1667491341865 implements MigrationInterface {
    name = 'ongUpdate1667491341865'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ongs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(30) NOT NULL, "tel" character varying(15) NOT NULL, "description" character varying(600) NOT NULL, "cpnj" character varying(14) NOT NULL, "balance" numeric(10,2) NOT NULL DEFAULT '0', "age" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "categoryId" uuid, "userId" uuid, CONSTRAINT "UQ_0969876d463a63c64efb5fcd683" UNIQUE ("email"), CONSTRAINT "UQ_0aedd0bd7cf01c526310702dde3" UNIQUE ("cpnj"), CONSTRAINT "REL_b227960f3249b2ab55df7fb19a" UNIQUE ("userId"), CONSTRAINT "PK_bcd0edd4e9d5fb34b6e0b8c06d2" PRIMARY KEY ("id"))`);
